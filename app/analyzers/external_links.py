...
<strong>Типи за передачею "ваги":</strong>
• <strong>Dofollow</strong> — передає PageRank (link juice) цільовому сайту
• <strong>Nofollow</strong> (<code>rel="nofollow"</code>) — не передає вагу, рекомендовано для реклами
• <strong>Sponsored</strong> (<code>rel="sponsored"</code>) — для платних/партнерських посилань
• <strong>UGC</strong> (<code>rel="ugc"</code>) — для посилань у коментарях користувачів

<strong>Вплив на SEO:</strong>
• Посилання на авторитетні джерела підвищує довіру до контенту
• Надмірна кількість вихідних посилань "розводнює" вагу сторінки
• Посилання на спамні сайти може нашкодити репутації

<strong>Рекомендації:</strong>
• Посилайтеся на релевантні авторитетні джерела
• Використовуйте nofollow для комерційних посилань
• Перевіряйте, чи цільові сайти ще працюють
• Відкривайте зовнішні посилання у новій вкладці (<code>target="_blank"</code>)
• Додавайте <code>rel="noopener"</code> для безпеки

<strong>Оптимальне співвідношення:</strong>
Загальноприйнято мати баланс між dofollow та nofollow посиланнями."""
